...
public class GeneralAvroConsumer {
    private static final Logger log = LoggerFactory.getLogger(GeneralAvroConsumer.class);

    public static void readTopic(String topicName) throws UnsupportedEncodingException {
